...
INSERT INTO [UserPermission] (UserPermissionId, UserId, PermissionName, ResourceType, ResourceId, CanCreate, CanRead, CanUpdate, CanDelete, CanExecute, CreatedDateTime, ModifiedDateTime, CreatedBy, ModifiedBy, IsDeleted)
VALUES (160, 4, 'adr', NULL, NULL, 0, 1, 1, 0, 0, '2025-11-26 03:16:06.0686020', '2025-11-26 03:16:06.0686020', 'Default Admin', 'Default Admin', 0);
...
UPDATE [User] SET PasswordHash='AQAAAAIAAYagAAAAEHwNKy51I8oNB+Vy6qIFX9uq8om8SAb06M0vKHPmLUuCYStaqk6ZRA+K3YTwB6EXxQ==' WHERE UserId=2
UPDATE [User] SET PasswordHash='AQAAAAIAAYagAAAAEFQ1PjJxQLA/CcdvWH9K4MKTqNTEyqCamJkR8dtDfe4nsZ9YUm52300NHWinykzEmA==' WHERE UserId=3
UPDATE [User] SET PasswordHash='AQAAAAIAAYagAAAAEC9yxm+Vsnbu/mgvW50SDHWWmdeM4cdpRvsRIQaVuwRfIt/x9jD6s+BVMjULOO17Pw==' WHERE UserId=4
...
VALUES (1, 1, 0, 1, NULL, 'lcassin@cassinfo.com', NULL, 'FAILED: Daily Log Cleanup', 1, 1, GETUTCDATE(), GETUTCDATE(), 'System Seed', 'System Seed', 0),
       (2, 2, 0, 1, NULL, 'lcassin@cassinfo.com', NULL, 'FAILED: ADR Account Sync', 1, 1, GETUTCDATE(), GETUTCDATE(), 'System Seed', 'System Seed', 0),
       (3, 3, 0, 1, NULL, 'lcassin@cassinfo.com', NULL, 'FAILED: ADR Full Cycle', 1, 1, GETUTCDATE(), GETUTCDATE(), 'System Seed', 'System Seed', 0);

...
public interface IDashboardService
{
    ...
    Task<List<StatusBreakdownItem>> GetStatusBreakdownAsync(int hours = 24, int? clientId = null, List<JobStatus>? statuses = null);
    ...
    Task<(List<RecentExecutionItem> Items, bool HasMore)> GetRecentExecutionsAsync(int hours = 24, int? clientId = null, List<JobStatus>? statuses = null, int limit = 10);
}

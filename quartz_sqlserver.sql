-- Quartz.NET 3.x SQL Server Schema Script
-- Run this script against your SchedulerPlatform database to create the Quartz tables
-- Required for the persistent job store to function
...
PRINT 'Quartz.NET tables created successfully!';
